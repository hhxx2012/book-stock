...
const DEFAULT_ROLES = [
  { id: 'super', role: 'super', name: '超级管理员', label: '超级管理员', permissions: ['manage_system', 'manage_users', 'manage_roles', 'manage_subjects', 'manage_books', 'stock_in', 'stock_out', 'stock_return', 'stock_transfer', 'view_stock', 'forecast_view', 'forecast_set', 'forecast_approve', 'forecast_modify', 'forecast_delete', 'forecast_stats', 'receive_view', 'receive_set', 'receive_approve', 'receive_modify', 'receive_delete', 'delete_book', 'view_stats', 'qrcode_generate'] },
  { id: 'admin', role: 'admin', name: '管理员', label: '管理员', permissions: ['manage_users', 'manage_subjects', 'stock_in', 'stock_out', 'stock_return', 'stock_transfer', 'view_stock', 'forecast_view', 'forecast_set', 'forecast_approve', 'forecast_modify', 'forecast_delete', 'forecast_stats', 'receive_view', 'receive_set', 'receive_approve', 'receive_modify', 'receive_delete', 'delete_book', 'view_stats', 'qrcode_generate'] },
  { id: 'educational', role: 'educational', name: '教务', label: '教务', permissions: ['stock_in', 'stock_out', 'stock_return', 'stock_transfer', 'view_stock', 'forecast_view', 'forecast_set', 'forecast_approve', 'forecast_modify', 'forecast_stats', 'receive_view', 'receive_set', 'receive_approve', 'receive_modify'] },
